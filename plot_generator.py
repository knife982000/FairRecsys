...
#         ax.scatter(items, exposure, s=1, alpha=0.6, label=method)
#     ax.axhline(y=fair_exposure, color='black', linestyle='--', label='Fair Exposure')
#     ax.set_xlabel('Items')
...
def plot_data(exposure_data: Dict[str, List[float]], dataset: str, fair_exposure: float):
    ...
    fig.add_trace(go.Scatter(x=[0, len(items)], y=[fair_exposure, fair_exposure], mode='lines', name='Fair Exposure', line=dict(dash='dash')))
    y_max = 0
    ...
    fig.update_layout(
        ...
        yaxis_tickvals=[0.1, 1, 5, 10, 50, 100, 500, 1000, 5000, 10000, 20000, 50000, 100000],
        yaxis_ticktext=["0", "1", "5", "10", "50", "100", "500", "1K", "5K", "10K", "20K", "50K", "100K"],
        xaxis_tickvals=[0.1, 1, 5, 10, 100, 1000, 10000, 100000, 1000000],
        xaxis_ticktext=["0", "1", "5", "10", "100", "1K", "10K", "100K", "1M"],
        font=dict(size=18),
